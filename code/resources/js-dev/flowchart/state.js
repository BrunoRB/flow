...
Flow.State = {
    ...
    SHAPE_ALTERATION: "shapeAlteration",

    SHAPE_DELETION: "shapeDeletion",

    SHAPE_CREADTED: "shapeCreated",

    CONNECTION_ALTERATION: "connectionAlteration",
    ...
    pushShapeAlteration: function($shape) {
        ...
        var obj = {};
        obj[idFlowchart] = {};
        obj[idFlowchart][this.SHAPE_ALTERATION] = flow.ShapeHandler.getShapeData($shape);
    ...
    pushShapeDeletion: function($shape) {
        ...
        var obj = {};
        obj[idFlowchart] = {};
        obj[idFlowchart][this.SHAPE_DELETION] = $.extend(
            flow.ShapeHandler.getShapeData($shape),
    ...
    _getShapeTargetsOfShapeConnections: function($shape) {
        ...
        for (var i = 0; i < connections.length; i++) {
            targets.push({
                ...
                label: $(connections[i].getLabel()).text()
            });
        }
        return targets;
    },
